...
Welcome to ``Tay_Project`` contributor's guide.
...
If you experience bugs or general issues with ``Tay_Project``, please have a look
...
You can help improve ``Tay_Project`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``Tay_Project`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``Tay_Project``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n Tay_Project python=3 six virtualenv pytest pytest-cov
    conda activate Tay_Project
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/Tay_Project.git
    cd Tay_Project
...
#. Install |pre-commit|_::
   ...
   ``Tay_Project`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/Tay_Project
.. _issue tracker: https://github.com/<USERNAME>/Tay_Project/issues
.. <-- end -->
