...
#         with mock.patch('builtins.input', side_effect = ['a','testing_acct.csv']):
#                 self.main_user_collection, self.main_status_collection = menu.initialize(self.database)
#                 menu.menu_options_function(self.main_user_collection, self.main_status_collection, self.database)
