...
def load_users(data_base):
    ...
    logging.info(f"Assignment 03 load user csv total time: {(time.time()-init_time)*1000:.4f} Milliseconds.")
...
def load_status_updates(data_base):
    ...
    logging.info(f"Assignment 03 load status csv total time: {(time.time()-init_time)*1000:.4f} Milliseconds.")
...
def add_user(user_collection):
    ...
    logging.info(f"Assignment 03 add user total time: {(time.time()-init_time)*1000:.4f} Milliseconds.")
...
def update_user(user_collection):
    ...
    logging.info(f"Assignment 03 update user total time: {(time.time()-init_time)*1000:.4f} Milliseconds.")
...
def search_user(user_collection):
    ...
    logging.info(f"Assignment 03 search user total time: {(time.time()-init_time)*1000:.4f} Milliseconds.")
...
def delete_user(user_collection):
    ...
    logging.info(f"Assignment 03 delete user total time: {(time.time()-init_time)*1000:.4f} Milliseconds.")
...
def add_status(status_collection):
    ...
    logging.info(f"Assignment 03 add status total time: {(time.time()-init_time)*1000:.4f} Milliseconds.")
...
def update_status(status_collection):
    ...
    logging.info(f"Assignment 03 update status total time: {(time.time()-init_time)*1000:.4f} Milliseconds.")
...
def search_status(status_collection):
    ...
    logging.info(f"Assignment 03 search status total time: {(time.time()-init_time)*1000:.4f} Milliseconds.")
