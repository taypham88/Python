...
class UserStatus():
    ...
    def __init__(self, status_id, user_id, status_text):
        ...
        logging.info("UserStatus Class function called.")
...
class UserStatusCollection():
    ...
    def __init__(self):
        self.database = {}
        logging.info("UserStatusCollection intialized")
    ...
    def add_status(self, status_id, user_id, status_text):
        ...
        if status_id in self.database:
            ...
            logging.warning("user_status.add_status returned False, no status_id found.")
            return False
    ...
    def modify_status(self, status_id, user_id, status_text):
        ...
        if status_id not in self.database:
            ...
            logging.warning("user_status.modify_status returned False, no status_id found.")
            return False
    ...
    def delete_status(self, status_id):
        ...
        if status_id not in self.database:
            ...
            logging.warning("user_status.delete_status returned False, no status_id found.")
            return False
    ...
    def search_status(self, status_id):
        ...
        if status_id not in self.database:
            ...
            logging.warning("user_status.search_status returned False, no status_id found.")
